                ...
                <div class="container-fluid">
                    <div class="row" id="page-contents">
                        <div class="col-lg-3">
                            ...
                            <div class="modal fade" id="myProductsModal" tabindex="-1" role="dialog"
                                aria-labelledby="myProductsModalLabel" aria-hidden="true">
                                            ...
                                            <form action="{{ route('products.store') }}" method="post"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" id="name"
                                                        placeholder="name" class="form-control" class="styled-input"
                                                        style="background-color: #e9f5f9;"></input>
                                                </div>
                                                <div class="form-group">
                                                    <label for="description">description:</label>
                                                    <textarea name="description" id="description" placeholder="description" class="form-control" rows="4"
                                                        style="background-color: #e9f5f9;"></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="prix">Prix:</label>
                                                    <input type="number" name="prix" id="prix"
                                                        class="form-control" min="1" placeholder="price"
                                                        style="background-color: #e9f5f9;" />
                                                </div>
                                                ...
                                                <button type="submit" class="mtr-btn"><span>Create
                                                        product</span></button>
                                                <a href="{{ route('home') }}" class="mtr-btn"
                                                    title=""><span>Cancel</span></a>
                                                    ...
                                                    @foreach ($allProducts as $product)
                                                        <div
                                                            ...
                                                            <img class="d-block w-100"
                                                                src="{{ Vite::asset('storage/app/public/' . $product->file) }}"
                                                                alt="Image">
                                                        </div>
                                                    @endforeach
                                                </div>
                                            ...
                                            <div class="card product-card mb-3">
                                                <div class="card-body">
                                                    ...
                                                    <p class="time-post">Created at:
                                                        {{ $product->created_at->format('l F jS') }}</p>
                                                    ...
                                                    <div class="like-section">
                                                        ...
                                                        @if ($product->user_id != auth()->user()->id)
                                                            @if ($product->likedByUser(auth()->user()))
                                                                <form
                                                                    action="{{ route('products.like', $product->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                ...
                                                <div class="card-body">
                                                    <div class="contact-messages p-3">
                                                        ...
                                                        <div style="max-height: 300px; overflow-y: auto;">
                                                            ...
                                                            @foreach ($contactMessages[$product->id] as $message)
                                                                <div class="contact-message"
                                                                    style="border: 1px solid; padding: 10px; margin: 10px 0; border-radius: 8px; background-color: #e9f5f9;">
                                                                    ...
                                                                    @if (auth()->user()->id === $message->sender_id)
                                                                        <form method="post"
                                                                            action="{{ route('products.deleteMessage', ['product_id' => $product->id, 'message_id' => $message->id]) }}">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <button type="submit"
                                                        ...
                                                        @if (auth()->user()->id === $product->user_id)
                                                            ...
                                                            <form method="post"
                                                                action="{{ route('products.contact', ['product_id' => $product->id]) }}">
                                                                @csrf
                                                                <div class="form-group">
                                                                    <label for="message">Message</label>
                                                                    <textarea name="message" class="form-control" rows="4" required
                                                                        style="border: 1px solid #000; background-color: ghostwhite"></textarea>
                                                                </div>
                                                                <button type="submit"
                                                                    class="btn btn-success">Répondre</button>
                                                            </form>
                                                        @else
                                    ...
                                    <div class="col-md-12 text-center">
                                        <ul class="pagination justify-content-center">
                                            ...
                                            @for ($i = 1; $i <= $products->lastPage(); $i++)
                                                <li
                                                    class="page-item{{ $i === $products->currentPage() ? ' active' : '' }}">
