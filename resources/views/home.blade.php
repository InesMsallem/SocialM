                                    ...
                                    <aside class="sidebar static">
                                        ...
                                        <div class="widget stick-widget">
                                            ...
                                            <ul class="followers">
                                                <li>
                                                    <figure><img
                                                            src="{{ Vite::asset('resources/assets/images/resources/friend-avatar2.jpg') }}"
                                                            alt=""></figure>
                                                ...
                                                <li>
                                                    <figure><img
                                                            src="{{ Vite::asset('resources/assets/images/resources/friend-avatar4.jpg') }}"
                                                            alt=""></figure>
                                                    <div class="friend-meta">
                                                ...
                                                <li>
                                                    <figure><img
                                                            src="{{ Vite::asset('resources/assets/images/resources/friend-avatar6.jpg') }}"
                                                            alt=""></figure>
                                                    <div class="friend-meta">
                                                ...
                                                <li>
                                                    <figure><img
                                                            src="{{ Vite::asset('resources/assets/images/resources/friend-avatar8.jpg') }}"
                                                            alt=""></figure>
                                                    <div class="friend-meta">
                                                ...
                                                <li>
                                                    <figure><img
                                                            src="{{ Vite::asset('resources/assets/images/resources/friend-avatar3.jpg') }}"
                                                            alt=""></figure>
                                                    <div class="friend-meta">
                                ...
                                <div class="col-lg-6">
                                    <div class="central-meta">
                                        <div class="new-postbox">
                                            <figure>
                                                <img src="{{ Vite::asset('resources/assets/images/resources/admin2.jpg') }}"
                                                    alt="">
                                            </figure>
                                    ...
                                    <div class="loadMore">
                                        ...
                                        <div class="central-meta item">
                                            <div class="user-post">
                                                <div class="friend-info">
                                                    <figure>
                                                        <img src="{{ Vite::asset('resources/assets/images/resources/nearly1.jpg') }}"
                                                            alt="">
                                                    </figure>
                                                    <div class="friend-name">
                                        ...
                                        <div class="central-meta item">
                                            <div class="user-post">
                                                <div class="friend-info">
                                                    <figure>
                                                        <img src="{{ Vite::asset('resources/assets/images/resources/nearly6.jpg') }}"
                                                            alt="">
                                                    </figure>
                                                    <div class="friend-name">
                                        ...
                                        <div class="central-meta item">
                                            <div class="user-post">
                                                <div class="friend-info">
                                                    <figure>
                                                        <img alt=""
                                                            src="{{ Vite::asset('resources/assets/images/resources/friend-avatar10.jpg') }}">
                                                    </figure>
                                                    <div class="friend-name">
                                                    ...
                                                    <div class="description">
                                                        ...
                                                        <p>
                                                            Curabitur World's most beautiful car in <a title=""
                                                                href="#">#test drive booking !</a> the most
                                                    ...
                                                    <div class="post-meta">
                                                        <div class="linked-image align-left">
                                                            <a title="" href="#"><img alt=""
                                                                    src="{{ Vite::asset('resources/assets/images/resources/page1.jpg') }}"></a>
                                                        </div>
                                                        <div class="detail">
                                    ...
                                    <aside class="sidebar static">
                                        <div class="widget">
                                            ...
                                            <div class="your-page">
                                                <figure>
                                                    <a href="#" title=""><img
                                                            src="{{ Vite::asset('resources/assets/images/resources/friend-avatar9.jpg') }}"
                                                            alt=""></a>
                                                </figure>
                                                <div class="page-meta">
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane active fade show " id="link1">
                                                            ...
                                                            <div class="users-thumb-list">
                                                                <a href="#" title="Anderw"
                                                                    data-toggle="tooltip">
                                                                    <img src="{{ Vite::asset('resources/assets/images/resources/userlist-1.jpg') }}"
                                                                        alt="">
                                                                </a>
                                                                <a href="#" title="frank"
                                                                    data-toggle="tooltip">
                                                                    <img src="{{ Vite::asset('resources/assets/images/resources/userlist-2.jpg') }}"
                                                                        alt="">
                                                                </a>
                                                                <a href="#" title="Sara"
                                                                    data-toggle="tooltip">
                                                                    <img src="{{ Vite::asset('resources/assets/images/resources/userlist-3.jpg') }}"
                                                                        alt="">
                                                                </a>
                                                                <a href="#" title="Amy"
                                                                    data-toggle="tooltip">
                                                                    <img src="{{ Vite::asset('resources/assets/images/resources/userlist-4.jpg') }}"
                                                                        alt="">
                                                                </a>
                                                                <a href="#" title="Ema"
                                                                    data-toggle="tooltip">
                                                                    <img src="{{ Vite::asset('resources/assets/images/resources/userlist-5.jpg') }}"
                                                                        alt="">
                                                                </a>
                                                                <a href="#" title="Sophie"
                                                                    data-toggle="tooltip">
                                                                    <img src="{{ Vite::asset('resources/assets/images/resources/userlist-6.jpg') }}"
                                                                        alt="">
                                                                </a>
                                                                <a href="#" title="Maria"
                                                                    data-toggle="tooltip">
                                                                    <img src="{{ Vite::asset('resources/assets/images/resources/userlist-7.jpg') }}"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                        </div>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="friendz-meta">
                                                        ...
                                                        <i><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                                                data-cfemail="bdcad4d3c9d8cfced2d1d9d8cffddad0dcd4d193ded2d0">[email&#160;protected]</a></i>
                                                    </div>
                                                </li>
                                                <li>
                                                    <figure>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                        <div class="widget">
                            <div class="foot-logo">
                                <div class="logo">
                                    <a href="home" title=""><img src="images/logo.png"
                                            alt=""></a>
                                </div>
                                <p>
