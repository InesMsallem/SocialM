							...
							<div class="col-lg-8">
									<div class="central-meta">
										<div class="editing-info">
											...
											<form method="post"  action="{{ route('editGroupPutFront', $group->id) }}" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
												<div class="form-group">	
												  <input type="text" id="input" name="name" value="{{ $group->name }}" />
												...
												<div class="submit-btns">
													...
													<button type="submit" class="mtr-btn"><span>Edit Group</span></button>
												</div>
											</form>
										</div>
									</div>	
